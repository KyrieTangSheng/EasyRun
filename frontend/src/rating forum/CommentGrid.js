...
export default function CommentGrid(props) {
  ...
  //console.log(props.parentUserName)
    ...
    <Paper style={{ padding: `25px ${props.widthPad}px` }}>
      <Grid container wrap="nowrap" spacing={1}>
        ...
        <Grid item key={2}>
          ...
          {props.type === "rating" && (
            <StarComponent star={props.star}></StarComponent>
          )}

          <p style={{ textAlign: "left" }}>
            {props.type === "comment" && props.parentUserName
              ? "Reply to @" + props.parentUserName + ": \n" + props.content
              : props.content}
          </p>
          ...
          >
            {props.type === "rating" ? "comment" : "reply"}
          </Button>
          <DialogController
            open={dialogOpen}
